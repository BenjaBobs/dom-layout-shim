...
Do not add empty Changesets. A follow-up pull request may update an existing
pending Changeset when it refines the same unreleased change; independent
changes should use separate Changesets.
