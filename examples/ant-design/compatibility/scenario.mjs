...
export const scenario = {
  ...
  steps: [
    ...
    },
    {
      ...
      actions: [{ type: 'click', selector: '[data-layout-key="add-task"]' }],
      observe: [
        ...base,
    ...
    },
    {
      ...
      observe: [...base, '.ant-dropdown', '.ant-dropdown-menu-item-danger'],
    },
    {
      id: 'delete-dialog',
      label: 'Delete dialog open',
      actions: [{ type: 'click', selector: '.ant-dropdown-menu-item-danger' }],
      observe: [
        ...base,
