...
export function parseLengthPercentage(
  ...
  if (quantity?.number !== 0) return undefined;
...
export function parseNumberCalculation(value: string): number | undefined {
  ...
  return quantity && quantity.px === 0 && quantity.percent === 0
    ? quantity.number
    : undefined;
}
...
class CalculationParser {
  ...
  private primary(): Quantity | undefined {
    ...
    if (
      this.input.slice(this.index, this.index + 5).toLowerCase() === 'calc('
    ) {
      this.index += 5;
      const value = this.expression();
...
function quantity(token: string, context: LengthContext): Quantity | undefined {
  ...
  switch (unit) {
    ...
    case 'em':
      return context.fontSize === undefined
        ? undefined
        : pixels(value * context.fontSize);
    case 'rem':
      return context.rootFontSize === undefined
        ? undefined
        : pixels(value * context.rootFontSize);
    case 'vw':
      return context.viewport === undefined
        ? undefined
        : pixels((value * context.viewport.width) / 100);
    case 'vh':
      return context.viewport === undefined
        ? undefined
        : pixels((value * context.viewport.height) / 100);
    case 'vmin':
      return context.viewport === undefined
        ? undefined
        : pixels(
            (value *
              Math.min(context.viewport.width, context.viewport.height)) /
              100,
          );
    case 'vmax':
      return context.viewport === undefined
        ...
        : pixels(
            (value *
              Math.max(context.viewport.width, context.viewport.height)) /
              100,
          );
    default:
      return undefined;
...
export function resolveCalculatedDimension(
  value: SupportedDimension,
...
export function isCalculatedDimension(
  value: SupportedDimension,
